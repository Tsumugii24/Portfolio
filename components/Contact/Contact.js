          ...
          keyframes: [
            {
              "--text-opacity": 0,
              "--border-radius": 0,
              "--left-wing-background": "#708ade",
              "--right-wing-background": "#9f55ff",
              duration: 0.11,
            },
            {
              "--left-wing-background": "#1844d2",
              "--right-wing-background": "#8b31ff",
              duration: 0.14,
            },
            {
              "--left-body-background": "#416bec",
      ...
      <div className="section-container flex flex-col justify-center">
        <div className="flex flex-col work-wrapper">
          ...
          <h2 className="text-[1.65rem] font-medium md:max-w-lg w-full mt-2 seq">
            Feel free to contact if you have any questions🤔 and Welcome Friends from all over the World🤗{" "}
          </h2>
        </div>
